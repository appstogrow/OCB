...
class Survey(http.Controller):
    ...
    def _prepare_question_html(self, survey_sudo, answer_sudo, **post):
        ...
        if answer_sudo.state == 'done':
            survey_content = survey_sudo.env['ir.qweb']._render('survey.survey_fill_form_done', survey_data)
        else:
            survey_content = survey_sudo.env['ir.qweb']._render('survey.survey_fill_form_in_progress', survey_data)
        ...
        return {
            ...
            'survey_navigation': survey_sudo.env['ir.qweb']._render('survey.survey_navigation', survey_data),
